        ...
        scenarios: [
            ...
            "reserve_run_1981": ScenarioConfig(
                ...
                stateOverrides: ScenarioStateOverrideConfig(
                    ...
                    credibility: 0.40,
                    exchangeRate: 2.39,
                    currentAccountGDP: -0.055,
                    capitalAccountGDP: -0.030,
                    foreignReservesMonths: 1.25,
                    capitalControls: 0.12,
                    externalDebtGDP: 0.48,
                    fiscalBalanceGDP: -0.052,
                    politicalPressure: 56.0,
                    publicApproval: 39.0),
                environmentOverrides: ScenarioEnvironmentOverrideConfig(
                    worldInterestRate: 0.148,
                    tradingPartnerGrowth: -0.004,
                    oilPriceIndex: 232.0,
                    termsOfTrade: 0.88),
                introNews: [
