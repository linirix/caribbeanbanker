        ...
        scenarios: [
            ...
            "oil_shock_1973": ScenarioConfig(
                ...
                stateOverrides: ScenarioStateOverrideConfig(
                    ...
                    policyRate: 0.068,
                    credibility: 0.76,
                    currentAccountGDP: -0.018,
                    capitalAccountGDP: 0.010,
                    foreignReservesMonths: 4.8,
                    externalDebtGDP: 0.26,
                    fiscalBalanceGDP: -0.028,
                    politicalPressure: 21.0,
                    publicApproval: 56.0),
                environmentOverrides: ScenarioEnvironmentOverrideConfig(
                    worldInterestRate: 0.062,
                    tradingPartnerGrowth: 0.022,
                    oilPriceIndex: 130.0,
                    commodityPriceIndex: 104.0),
                introNews: [
                ...
                goals: [
                    ScenarioGoalConfig(description: "Finish with inflation below 10%.",
                                       condition: StateConditionConfig(maxInflation: 0.10)),
                    ScenarioGoalConfig(description: "Keep reserves above 2.5 months.",
                                       condition: StateConditionConfig(minForeignReservesMonths: 2.5)),
                    ScenarioGoalConfig(description: "Keep political pressure below 70.",
                                       condition: StateConditionConfig(maxPoliticalPressure: 70.0))
                ]),
            ...
            "reserve_run_1981": ScenarioConfig(
                ...
                stateOverrides: ScenarioStateOverrideConfig(
                    ...
                    credibility: 0.44,
                    exchangeRate: 2.39,
                    currentAccountGDP: -0.049,
                    capitalAccountGDP: -0.018,
                    foreignReservesMonths: 1.6,
                    capitalControls: 0.28,
                    externalDebtGDP: 0.46,
                    fiscalBalanceGDP: -0.052,
                    politicalPressure: 52.0,
                    publicApproval: 41.0),
                environmentOverrides: ScenarioEnvironmentOverrideConfig(
                    worldInterestRate: 0.155,
                    tradingPartnerGrowth: 0.0,
                    oilPriceIndex: 228.0,
                    termsOfTrade: 0.9),
                introNews: [
                ...
                goals: [
                    ScenarioGoalConfig(description: "Finish with reserves above 1.8 months.",
                                       condition: StateConditionConfig(minForeignReservesMonths: 1.8)),
                    ScenarioGoalConfig(description: "Keep inflation below 11%.",
                                       condition: StateConditionConfig(maxInflation: 0.11)),
                    ScenarioGoalConfig(description: "Keep political pressure below 75.",
                                       condition: StateConditionConfig(maxPoliticalPressure: 75.0))
                ]),
            ...
            "confidence_rebuild_1998": ScenarioConfig(
                ...
                stateOverrides: ScenarioStateOverrideConfig(
                    ...
                    capitalAccountGDP: -0.006,
                    foreignReservesMonths: 1.9,
                    capitalControls: 0.26,
                    externalDebtGDP: 0.53,
                    fiscalBalanceGDP: -0.041,
                    politicalPressure: 34.0,
                    publicApproval: 46.0),
                environmentOverrides: ScenarioEnvironmentOverrideConfig(
                    worldInterestRate: 0.068,
                    tradingPartnerGrowth: 0.011,
                    oilPriceIndex: 116.0,
